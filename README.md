...
This app was developed to analyse commodity futures prices by creating a continuous curve based on the most actively traded contracts. The continuous curve shows the actual settlement prices of each contract (not forward/backward adjustments), but daily returns are calculated considering their roll date. 
